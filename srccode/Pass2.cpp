...
void copy()
{
    fstream transer;transer.open("intermediate1.txt",ios::out | ios::app);
    fstream intm2;intm2.open("intermediate.txt");
    transer<<intm2.rdbuf()<<endl;
...
void run2()
{
    ...
    run();
    cout<<"entered pass2_________________________________________________________________________________________________________________________"<<endl;      
    string a[6];
    char ch;
    hexa start;
    if(0)
    ...
    while(true)
    {
       // cout<<"*********************************************************************************************************************************************"<<endl;
        ...
        if(a[2]=="END")
        {
            ...
            obj.close();
            mod.close();       
           cout<<"endedone________________________________________________________";  
            break;
        }
...
void assemble(string a[])
{
    ...
    if(a[2]=="USE")
    {
        ...
        cout<<curr_block<<"                         SDFGHJKLKJHGFDSDFGHUIOP:LKJHGFDXDFGHJKLKJHGFCX"<<endl;
